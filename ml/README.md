...
## 8. 모델 디벨롭 v2 — 과거 히스토리 + 등급 (수집 대기 중)

성능 한계의 근본 원인(히스토리 21일 + 등급 부재)을 해결하기 위한 확장판입니다.
MAFRA 레거시 경락가격 API(~2023-12, **등급 특/상/중/하 포함**, 현행과 동일 시장코드)에서
과거 수년치를 수집해 계절성과 등급 구조를 학습합니다.
