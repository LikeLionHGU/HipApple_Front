    ...
    <div className="landing-page">
      <header className="landing-nav">
        ...
        <div className="landing-nav-actions">
          ...
          <button className="landing-btn" type="button" onClick={() => navigate('/signup')}>
            시작하기
          </button>
        </div>
      </header>
        ...
        <section className="hero">
          <div className="hero-text">
            ...
            <p className="hero-desc">
              저장고 상태부터 시장 시세 예측까지 한 곳에서.<br />
              팜사인이 최적의 출하 시기를 찾아드립니다.
            </p>
            <div className="hero-cta">
              <button className="landing-btn lg" type="button" onClick={() => navigate('/signup')}>
                무료로 시작하기
              </button>
              <button className="landing-btn-ghost lg" type="button" onClick={() => navigate('/login')}>
                로그인
              </button>
            </div>
          </div>
          ...
          <div className="hero-visual" aria-hidden="true">
            <div className="visual-card">
              ...
              <svg viewBox="0 0 260 120" className="visual-chart">
                ...
                <path d="M0,90 L40,80 L80,88 L120,60 L160,66 L200,40 L260,30 L260,120 L0,120 Z" fill="url(#landGrad)" />
                <path d="M0,90 L40,80 L80,88 L120,60" fill="none" stroke="#1BC485" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M120,60 L160,66 L200,40 L260,30" fill="none" stroke="#1BC485" strokeWidth="3" strokeDasharray="6 5" strokeLinecap="round" strokeLinejoin="round" />
                <circle cx="120" cy="60" r="4.5" fill="#fff" stroke="#1BC485" strokeWidth="3" />
              </svg>
